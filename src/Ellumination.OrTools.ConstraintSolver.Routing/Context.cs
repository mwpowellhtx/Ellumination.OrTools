...
namespace Ellumination.OrTools.ConstraintSolver.Routing
{
    ...
    public abstract class Context : IDisposable
    {
        ...
        protected Context(RoutingModelParameters modelParameters = null)
            : this(default, null)
        {
        }

        protected Context(int depot, RoutingModelParameters modelParameters = default)
        {
        }
        ...
        protected Context(int nodeCount, int vehicleCount, int depot = default)
            : this(nodeCount, vehicleCount, depot, null)
        {
        }
        ...
        protected Context(int nodeCount, int vehicleCount, int depot = default, RoutingModelParameters modelParameters = default)
        {
        ...
        protected Context(int nodeCount, int vehicleCount, IEnumerable<int> starts, IEnumerable<int> ends)
            : this(nodeCount, vehicleCount, starts, ends, null)
        {
        }
        ...
        /// <param name="ends"></param>
        /// <param name="modelParameters"></param>
        protected Context(int nodeCount, int vehicleCount, IEnumerable<int> starts, IEnumerable<int> ends, RoutingModelParameters modelParameters)
        {
            this.NodeCount = nodeCount;
            this.VehicleCount = vehicleCount;
            // TODO: TBD: verify that depot indexes are correct...
