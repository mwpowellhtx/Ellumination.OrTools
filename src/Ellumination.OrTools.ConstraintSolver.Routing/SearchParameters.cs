...
namespace Ellumination.OrTools.ConstraintSolver.Routing
{
    ...
    public class SearchParameters : Parameters
    {
        ...
        /// <summary>
        /// Number of expensive arcs to consider cutting in the <em>RelocateExpensiveChain</em>
        /// neighborhood operator (see
        /// <c>LocalSearchNeighborhoodOperators.use_relocate_expensive_chain</c>). This parameter
        /// must be greater than <c>2</c>. User note, the number of neighbors generated by the
        /// operator for <c>relocate_expensive_chain_num_arcs_to_consider = K</c> is
        ...
        /// </summary>
        public virtual long TimeLimitSeconds { get; set; }

        /// <summary>
        /// Limit to the time spent in the search.
        /// </summary>
        public virtual int? TimeLimitNanos { get; set; }
        ...
        /// <em>unspecified</em>. If this value is fractional, it will get rounded to the nearest
        /// integer.
        /// </summary>
        ...
        /// </summary>
        public virtual long LnsTimeLimitSeconds { get; set; }

        /// <summary>
        /// Limit to the time spent in the completion search for each local search neighbor.
        /// </summary>
        public virtual int? LnsTimeLimitNanos { get; set; }
        ...
        /// search will be used depending on the value of <c>use_depth_first_search</c>. Will
        /// be run before the CP-SAT solver, <see cref="UseCpSat"/>.
        /// </summary>
        /// <see cref="UseCpSat"/>
        ...
        /// instead of <em>light</em> propagation only. Full propagation is only necessary when
        ...
        private static SearchParameters CopyFrom(SearchParameters target, RoutingSearchParameters source)
        {
            ...
            // Anticipating Duration Deconstruction in a future Ellumination.Protobuf release.
            (target.TimeLimitSeconds, target.TimeLimitNanos) = source.TimeLimit;
            ...
            (target.LnsTimeLimitSeconds, target.LnsTimeLimitNanos) = source.LnsTimeLimit;
        ...
        private static RoutingSearchParameters CopyTo(SearchParameters source, RoutingSearchParameters target)
        {
            ...
            target.UseDepthFirstSearch = source.UseDepthFirstSearch;
            // Anticipating Duration Deconstruction in a future Ellumination.Protobuf release.
            target.TimeLimit = source.TimeLimitSeconds.AsDuration(source.TimeLimitNanos);
            target.UseCpSat = source.UseCpSat;
            target.ContinuousSchedulingSolver = source.ContinuousSchedulingSolver;
            target.MixedIntegerSchedulingSolver = source.MixedIntegerSchedulingSolver;
            target.OptimizationStep = source.OptimizationStep;
            target.NumberOfSolutionsToCollect = source.NumberOfSolutionsToCollect;
            target.SolutionLimit = source.SolutionLimit;
            target.LnsTimeLimit = source.LnsTimeLimitSeconds.AsDuration(source.LnsTimeLimitNanos);
            target.ChristofidesUseMinimumMatching = source.ChristofidesUseMinimumMatching;
            target.UseCp = source.UseCp;
            target.CheapestInsertionLsOperatorNeighborsRatio = source.CheapestInsertionLsOperatorNeighborsRatio;
            target.LogSearch = source.LogSearch;
